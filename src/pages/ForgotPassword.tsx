          ...
          <div className="mt-8 space-y-6 text-center">
            <div className="bg-zinc-50 p-6 rounded-lg border border-zinc-200">
              <p className="text-sm text-zinc-700 mb-6">
                To reset your password, please contact our support team on WhatsApp and provide your registered phone number.
              </p>
              <a 
                href="https://wa.link/77jcui" 
                target="_blank" 
                rel="noreferrer" 
                className="inline-flex items-center justify-center gap-2 bg-green-600 text-white px-6 py-3 rounded-md font-medium hover:bg-green-700 transition-colors w-full"
              >
